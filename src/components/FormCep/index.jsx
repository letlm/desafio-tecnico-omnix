  ...
  return (
    <section className=" bg-blue400 w-11/12 md:w-3/4 h-[150px] mt-10">
      ...
      >
        ...
        <input
          class="w-11/12 md:w-3/4 placeholder:text-slate-400 block bg-white border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
        ...
        <button className="bg-blue500 text-white w-48 h-10 rounded-full cursor-pointer focus:outline-none hover:bg-sky-700">
          Pesquisar planos
        </button>
      </form>
    </section>
